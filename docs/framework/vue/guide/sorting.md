...
table.atoms.sorting.get() // reactive inside templates and computed values; a snapshot elsewhere
```
...
const sorting = useSelector(sortingAtom) // a Vue ref
