...
Defined in: [features/column-filtering/createFilteredRowModel.ts:27](https://github.com/TanStack/table/blob/main/packages/table-core/src/features/column-filtering/createFilteredRowModel.ts#L27)
